...
def ingreso_numero_de_jugadores():
    ...
    return numJugadores
#Aqui se podran ingresar un determinado numero de nombres segun la cantidad de numero de jugadores 
#los cuales se guardaran en la lista "nombresJugadores"
...
#
#mandando como argumento carton1,carton2,carton3 y carton 4 y el numero de jugadores
...
#en esta funcion se imprime la palabra bingo una vez que haya alguien haya ganadom
def mensaje_ganador():
    '''
